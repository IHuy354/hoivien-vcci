...
export const galleryCategories = ["Tất cả", "Học tập", "Trao bằng", "Thuyết trình", "Kết nối"];
...
export const mainSponsor = { name: "VCCIIP", img: "https://s3.meu-solutions.com/skh-event/public/images/vcci-ip.jpg", url: "https://vcci.com.vn/" };
